...
def fetch_and_process_features(collection, year, batch_size=5000,shapefile_directory='path_to_shapefiles_directory'):
    ...
    shapefile_path = f'{shapefile_directory}/land_cover_{year}.shp'
...
def export_to_asset(gdf, year, subclass):
    ...
    asset_id = f'projects/ee-janetmumo68/assets/crop_monitoring_class/clean_raw_data_{year}_{subclass}'  # change to your GEE
